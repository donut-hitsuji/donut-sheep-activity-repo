(() => {
  ...
  const translations = {
    ja: {
      pageTitle: 'donut sheep — 鳴り響くビート、色彩のスケッチ。',
      metaDescription: '音楽プロジェクト「どーなつひつじ」のオフィシャルポータル。YouTubeのフルMV、Xのイラストや新曲プレビュー、各種配信ストアの楽曲をひとつの場所から。',
      ogLocale: 'ja_JP',
      ogDescription: '鮮烈なサウンドとアートワークが交差する音楽プロジェクト「どーなつひつじ」。YouTubeのMV、Xのデイリー投稿や先行音源、配信リリースへ。',
      twitterDescription: 'YouTubeのフルMV、Xのデイリーイラスト＆新曲プレビュー、各種ストリーミング配信。どーなつひつじの全チャンネルへ。',
      skipLink: '本文へスキップ',
      brandHomeLabel: 'donut sheep ホームへ戻る',
      navChannels: '3つの扉',
      navStreaming: 'ストリーミング',
      navYouTubeCta: 'YouTubeで観る',
      heroTitle: '<span>鳴り響くビート、</span><br><em>駆け抜ける色彩</em>',
      heroLead: 'どーなつひつじは、鮮烈なサウンドとポップなアートワークを繰り広げる音楽プロジェクト。YouTubeで公開中のフルMV、Xで毎日生まれるイラストや先行プレビュー、そして各種ストリーミングで聴けるリリース楽曲まで。自由に飛び込んで、お気に入りの音を見つけてください。',
      heroWatch: 'MVを観る',
      heroX: 'Xをチェック',
      heroArtistPage: 'アーティストページ',
      factsLabel: '活動ハイライト',
      galleryLabel: 'ドナ・メルシープのアートワークギャラリー',
      donaMultiverseAlt: '色鮮やかなサイバー空間に佇む羊娘ドナ・メルシープ',
      donaNoteAlt: 'ノートの枠線の中で眠そうに頬杖をつくドナ・メルシープ',
      donaSignalAlt: 'モニターの隙間からキャンディを差し出すドナ・メルシープ',
      scrollCue: '3つの扉へ',
      channelsTitle: '映像・アート・音<br><em>3つの扉。</em>',
      channelsLead: '映像でじっくり浸るか、日々のスケッチをリアルタイムで追うか、日常のプレイリストに加えるか。今の気分に合わせて、お好きな場所からどうぞ。',
      channelYouTubeTitle: '音と映像が躍動する、<br>フル尺MV',
      channelYouTubeLead: '楽曲とビジュアルがひとつに融合した映像作品を公開。',
      channelXTitle: '毎日のスケッチと、<br>生まれたての音',
      channelXLead: '日常のイラストや、新曲の先行プレビューをリアルタイムで発信。',
      channelStreamingTitle: '日常のプレイリストへ、<br>ストリーミング配信',
      channelStreamingLead: 'Apple MusicやSpotifyなど、いつものアプリですぐに聴ける楽曲たち。',
      youtubeTitle: '響きわたる音が、<br><em>鮮烈に動きだす。</em>',
      youtubeLead: 'YouTubeでは、サウンドと映像が融合したフルサイズMVを公開中。重なるビートと極彩色のカットの中へ。',
      youtubeAll: '公式チャンネルで全動画を見る',
      askRainFrameTitle: 'Ask the Rain ミュージックビデオ',
      askRainDescription: 'その天使は鐘を鳴らすたび願いを叶えてきた。',
      biteFrameTitle: 'Bite Through the Frame ミュージックビデオ',
      biteDescription: 'フレームを噛み破る。背負ってきた何かのために。',
      liliesFrameTitle: 'The Lilies Arrived on Time ミュージックビデオ',
      liliesDescription: '百合は正しく、定刻通りに届けられた。',
      youtubeProof: '「RISE, RISE」のMVは<strong>10万回再生</strong>を突破しました。<br>この音に出会い、耳を傾けてくれた一人ひとりへ感謝を。',
      watchRise: '「RISE, RISE」を観る',
      xTitle: '生まれたての音も、毎日のスケッチも。<br><em>最速のシグナルはXから。</em>',
      xLead: 'ドナ・メルシープを描く日々のスケッチから、新曲の先行プレビューまで。イラストと新しい音を、リアルタイムの熱量で発信しています。',
      sheepDiary: 'ひつじ日記',
      xMore: 'Xで最新ポストをチェック',
      streamingTitle: '日常の中に、<br><em>トラックを連れだす</em>',
      streamingLead: 'リリース済みの楽曲は、普段お使いの配信ストアですぐに再生可能。印象的なアートワークとともに、それぞれのトラックが紡ぐ独自の音世界を体験してください。',
      allReleases: 'すべての配信リリースを見る',
      drawStarsAlt: 'DRAW THE STARS ジャケットアートワーク',
      ...
      middleReleaseAlt: '水星のパジャマ ジャケットアートワーク',
      middleReleaseTitle: '水星のパジャマ',
      sunsetAlt: 'SUNSET TERMINAL 4039 ジャケットアートワーク',
      storeGuide: '各楽曲のページから、Apple MusicやSpotifyなどお好みの配信サービスを選択できます。',
      artistPageButton: 'アーティストページを見る',
      closingDonaAlt: 'こちらを見つめるドナ・メルシープ',
      closingTitle: '次の音楽で、<br><em>また会いましょう。</em>',
      closingLead: '今日も、新しいサウンドとアートが形づくられています。<br>YouTube、X、ストリーミング。いつでも好きなルートから、気ままに遊びに来てください。',
      closingArtistPage: '全配信リリース一覧',
